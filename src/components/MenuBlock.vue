<template>
  <header class="header-mobile" :class="isMenuOpen ? 'bg-white' : ''">
    ...
    <button class="menu-toggle" aria-label="open-close menu button" @click="isMenuOpen = !isMenuOpen">
      <svg
        v-if="isMenuOpen"
        width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg"
        class="close"
      >
        <path d="M4 4.98145L20 20.9814" stroke="#0F172A" stroke-width="2" stroke-miterlimit="10" />
        <path d="M20 4.98145L4 20.9814" stroke="#0F172A" stroke-width="2" stroke-miterlimit="10" />
      </svg>
